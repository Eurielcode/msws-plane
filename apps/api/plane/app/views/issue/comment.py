...
class IssueCommentViewSet(BaseViewSet):
    ...
    def create(self, request, slug, project_id, issue_id):
        ...
        if serializer.is_valid():
            ...
            queue_translations(workspace_id=issue.workspace_id, content_type="comment", content_id=serializer.instance.id, field="comment", text=serializer.instance.comment_html)
    ...
    def partial_update(self, request, slug, project_id, issue_id, pk):
        ...
        if serializer.is_valid():
            if "comment_html" in request.data and request.data["comment_html"] != issue_comment.comment_html:
                ...
                serializer.save()
            if "comment_html" in request.data:
                queue_translations(workspace_id=issue_comment.workspace_id, content_type="comment", content_id=issue_comment.id, field="comment", text=serializer.instance.comment_html)
            issue_activity.delay(
