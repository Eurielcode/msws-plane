...
from plane.bgtasks.translation_task import queue_translations
...
class IssueViewSet(BaseViewSet):
    ...
    @staticmethod
    def _queue_issue_translations(issue):
        queue_translations(workspace_id=issue.workspace_id, content_type="issue", content_id=issue.id, field="name", text=issue.name)
        queue_translations(workspace_id=issue.workspace_id, content_type="issue", content_id=issue.id, field="description", text=issue.description_html)
    ...
    def create(self, request, slug, project_id):
        ...
        if serializer.is_valid():
            serializer.save()
            self._queue_issue_translations(serializer.instance)
    ...
    def partial_update(self, request, slug, project_id, pk=None):
        ...
        if serializer.is_valid():
            serializer.save()
            if "name" in request.data or "description_html" in request.data:
                self._queue_issue_translations(serializer.instance)
